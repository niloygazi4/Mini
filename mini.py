...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "wake up" in permission or "wake up mini" in permission or "mini" in permission:
            TaskExecution()

        elif "stop the music" in permission or "stop" in permission:
            pyautogui.press("space")

        elif "I am going to sleep" in permission:
            speak("okay")
            sleep_auto_alarm()
            break
